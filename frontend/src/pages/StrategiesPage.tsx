      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 rounded-xl bg-ar-surface border border-ar-border text-ar-ink placeholder:text-ar-subtle focus:outline-none focus:border-ar-gold/60 focus:ring-2 focus:ring-ar-gold/25 transition-colors shadow-sm"
          />
        </div>
        <select
          value={catFilter}
        ...
        {filtered.map((s, i) => {
          ...
          return (
            <Link
              ...
              className="group strategy-card block h-full rounded-2xl border border-ar-border bg-gradient-to-br from-ar-surface via-surface-card to-surface-raised p-5 hover:border-ar-gold/50 transition-colors"
            >
