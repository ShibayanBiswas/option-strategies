  ...
  return (
    <div className="layman-greek-panel">
      <p className="layman-greek-intro">
        Tap each sensitivity below for a plain-English explanation—no prior options math required. Numbers update live when you change spot, strikes, or volatility.
      </p>
