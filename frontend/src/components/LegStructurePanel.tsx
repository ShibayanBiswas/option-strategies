          ...
          <motion.button
            ...
            className={`w-full text-left rounded-xl border p-4 transition-all ${
              isActive
                ...
                : "border-surface-border bg-surface/60 hover:border-slate-600"
            }`}
          >
            <div className="flex items-start justify-between gap-2">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span className="text-white font-medium">{leg.typeName}</span>
              </div>
            </div>
            {leg.subtitle && (
            ...
            <AnimatePresence>
              {isOpen && (
                ...
                >
                  <p className="text-sm text-slate-400 mt-3 leading-relaxed border-t border-surface-border pt-3 font-serif research-prose">
