...
export const GREEK_META: Record<GreekKey, GreekMeta> = {
  delta: {
    ...
    bg: "from-cyan-950/90 via-cyan-900/30 to-slate-950/80",
  },
  gamma: {
    key: "gamma",
    symbol: "Γ",
    ...
    bg: "from-violet-950/90 via-violet-900/30 to-slate-950/80",
  },
  theta: {
    key: "theta",
    symbol: "Θ",
    ...
    bg: "from-amber-950/90 via-amber-900/30 to-slate-950/80",
  },
  vega: {
    key: "vega",
    symbol: "ν",
    ...
    bg: "from-emerald-950/90 via-emerald-900/30 to-slate-950/80",
  },
  rho: {
    key: "rho",
    symbol: "ρ",
    ...
    bg: "from-rose-950/90 via-rose-900/30 to-slate-950/80",
  },
};
...
export const BIAS_STYLES: Record<string, { label: string; tone: string; ring: string; icon: LucideIcon }> = {
  ...
  "net-neutral": { label: "Net Neutral", tone: "text-cyan-300", ring: "from-cyan-500/60", icon: Compass },
};
