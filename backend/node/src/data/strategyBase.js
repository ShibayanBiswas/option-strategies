/**
 * Canonical strategy catalog — leg definitions align with backend/python/engine.py STRATEGY_LEGS
 */
export const rawStrategies = [
  ...
  },
  {
    ...
    section: "2.23",
    name: "Long Strangle",
    description: "Long OTM call K_1 and long OTM put K_2. Cheaper than a straddle but requires a larger move to reach breakeven; profits from large |S_T - K| moves.",
    outlook: "volatility",
  ...
  },
  {
    ...
    section: "2.26",
    name: "Short Strangle",
    description: "Short OTM call K_1 and short OTM put K_2. Less risky than a short straddle but lower initial premium; profits when S_T stays between the strikes.",
    outlook: "neutral",
  ...
  },
  {
    ...
    description: "Covered call augmented by writing an OTM put K_2 alongside short OTM call K_1, increasing income. Bullish outlook with wider profit zone than covered short straddle.",
    outlook: "bullish",
