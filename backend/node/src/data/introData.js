  ...
  greeks: [
    {
      ...
      paragraphs: [
        ...
        "Call deltas sit between zero and one. Deep out-of-the-money calls sit near zero because a small spot move rarely creates intrinsic value. Deep in-the-money calls sit near one and behave almost like long stock. Put deltas sit between minus one and zero: deep in-the-money puts approach −1, while deep out-of-the-money puts approach zero. Owning shares is like full positive delta; a long call is a fractional long stock position whose weight equals its delta.",
        "Market makers use delta to hedge. They buy or sell the underlying so that signed deltas cancel and the book stays roughly flat to spot. As a retail trader you rarely delta-hedge continuously, but the same number still tells you whether you are effectively long or short the market before expiry. Watching Δ_net on the live tiles is the fastest way to read directional bias after you move strikes or quantities.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Long options usually carry positive gamma. Favourable jumps help you because delta moves in your favour as the option goes deeper in-the-money. Unfavourable jumps still hurt, but positive gamma can soften mark-to-market pain relative to a pure short-premium book. Short options flip the sign: negative gamma means adverse moves hurt increasingly quickly, which is why naked short calls or puts can feel calm until a gap blows through the strike.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "A long straddle or strangle is primarily a bet on movement or vol expansion, which shows up as positive vega. Short-vol structures such as iron condors or short straddles carry negative vega: you benefit from a vol crush after events but suffer if uncertainty reprices higher. Income traders watch vega around earnings, policy meetings, and macro headlines because the terminal payoff may be unchanged while pre-expiry P/L moves sharply.",
        "At-the-money options with more time to expiration generally carry the most vega per unit of premium. Deep out-of-the-money weeklies have little vega because there is not much extrinsic value left to reprice. That is why calendar spreads and diagonals mix different vega profiles across expiries and can look quiet on spot while still moving on vol.",
        "Even when your expiry payoff looks fixed, pre-expiry profit and loss can swing on vol alone—that is vega at work. Compare realized movement with implied vol when diagnosing why a directionally correct trade still lost money on a quiet week. Use ν_net on the live tiles and profile chart to see whether you are net long or short vol at S_0, and pair that reading with gamma when sizing into known event dates.",
      ],
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Calls tend to have positive rho because higher rates increase the present-value benefit of deferring the cash outlay for stock. Puts tend to have negative rho for the mirror reason. In practice rho is often the smallest Greek for standard monthly equity options, so day-to-day P/L is usually driven by delta, gamma, theta, and vega instead.",
        "Long-dated LEAPS and rate-sensitive underlyings show more rho exposure. Large rate shifts can still nudge deep in-the-money calls and puts by measurable amounts when discounting matters over years rather than weeks. Portfolio managers hedging dividend and funding costs sometimes aggregate rho across books even when individual short-dated trades ignore it.",
        "Our engine includes the risk-free rate in Black–Scholes discounting, so ρ_net captures the model’s aggregate rate sensitivity rather than a hand-tuned adjustment. When comparing calls and puts at the same strike, rho helps explain small price differences that delta alone does not capture. Read ρ_net last after the other four Greeks: it completes the report without overstating its role on short-dated single-stock structures.",
      ],
